...
const useChatStore = create((set, get) => ({
  ...
  sendMockMessage: (text) => {
    ...
    setTimeout(() => {
      ...
      addMessage({
        ...
        sender: 'holly',
        suggestions: ['Tell me more', 'Show options', 'Get quotes', 'Ask another question'],
      })
  ...
  startNewConversation: () => {
    ...
    addMessage({
      type: 'gnome',
      content: "🧙‍♂️ Hi! I'm Holly, your moving assistant. I'm here to help you find the perfect moving solution. What would you like to know?",
      sender: 'holly',
      suggestions: ['Explain cross-loading', 'Show all options', 'Help me save money', 'Timeline questions'],
    })
  },
}))
