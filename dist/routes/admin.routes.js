...
import { getPersistenceState, setSaveHelperRequests, } from "../services/persistenceState.js";
import { createPriceSample, getPriceSampleStats, listPriceSamples, } from "../services/priceSamples.js";
const router = Router();
function isAuthorized(req) {
    const password = process.env.ADMIN_PASSWORD || process.env.ADMIN_TOKEN || "";
    if (!password)
        return false;
    return (req.get("x-admin-token") === password ||
