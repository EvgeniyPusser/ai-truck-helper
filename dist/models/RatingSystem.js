...
export class RatingCalculator {
    ...
    static calculateOverallRating(reviews) {
        ...
        const weightedScore = averages.overall * weights.overall +
    ...
    static calculateReliabilityScore(providerData) {
        ...
        const score = factors.completion_rate * weights.completion_rate +
    ...
    static calculateProfessionalismScore(providerData) {
        ...
        const score = factors.years_in_business * weights.years_in_business +
...
export class ReviewManager {
    ...
    static checkDuplicateReview(existingReviews, newReview) {
        return existingReviews.some(review => review.move_request_id === newReview.move_request_id &&
...
export class RatingAnalytics {
    ...
    static getProviderRatingAnalytics(reviews, timeRange = '12m') {
        ...
        const filteredReviews = reviews.filter(review => new Date(review.created_at) >= startDate);
        const monthlyData = {};
    ...
    static compareWithCompetitors(providerReviews, competitorReviews) {
        ...
        const competitorStats = competitorReviews.map(reviews => RatingCalculator.calculateOverallRating(reviews));
